...
$(document).ready(function () {
    ...
    function editRow(fTable, frow) {
        ...
        ftable[4].innerHTML = '<input type="text" class="form-control input-small" value="' + fData['phone'] + '">';
        ftable[5].innerHTML = '<input type="text" class="form-control input-small" value="' + fData['role'] + '">';
        ftable[6].innerHTML = '<input type="text" class="form-control input-small" value="' + fData['status'] + '">';
